...
class PredictionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post predictions_url, params: { prediction: { name: @prediction.name, prediction: @prediction.prediction } }
    end
  ...
  test "should update prediction" do
    patch prediction_url(@prediction), params: { prediction: { name: @prediction.name, prediction: @prediction.prediction } }
